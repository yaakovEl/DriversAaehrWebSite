    ...
    <main className="Home" dir="rtl">
      ...
      <header className="hero container">
        <div className="brand">
          ...
          <h1>שלום! הגעתם ל<strong>דרייברים</strong></h1>
          <p className="subtitle">
            משלוחים ונסיעות לכל הארץ במחירים הוגנים ונמוכים.
            הנסיעה מתבצעת על בסיס נסיעה שיתופית – התשלום מיועד לכיסוי דלק והוצאות שוטפות.
          </p>
        </div>
        ...
        <div className="cta-group">
          ...
          <a className="btn btn-call" href="tel:0534128066">
            ...
            <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" aria-hidden="true">
              <path d="M6.6 10.8c1.2 2.4 3.1 4.3 5.5 5.5l1.8-1.8c.3-.3.8-.4 1.2-.3 1 .3 2 .4 3.1.4.7 0 1.3.6 1.3 1.3V20c0 .7-.6 1.3-1.3 1.3C9.9 21.3 2.7 14.1 2.7 4.3 2.7 3.6 3.3 3 4 3h3.1c.7 0 1.3.6 1.3 1.3 0 1 .1 2.1.4 3.1.1.4 0 .9-.3 1.2l-1.9 2.2z"/>
            </svg>
            התקשרו עכשיו
          </a>
        </div>
      ...
      <footer className="footer container">
        <p>
          יש לכם שאלה? כתבו לנו בוואטסאפ או התקשרו – נשמח לעזור.
        </p>
        <div className="cta-inline">
          <a className="link-whatsapp" href={whatsappLink} target="_blank" rel="noreferrer">וואטסאפ</a>
          <span className="dot" />
